...
import com.lrs.lrsvideolibrary.view.utils.CacheMediaDataSource;
import com.lrs.lrsvideolibrary.view.utils.RxJavaUtil;
...
public class ViewTool implements IMediaPlayer.OnCompletionListener, IMediaPlayer.OnErrorListener,
    ...
    private SoftReference<BaseView> srPlayTextureView;
    ...
    public static ViewTool mMediaPlayerTool;
    public synchronized static ViewTool getInstance(){

        if(mMediaPlayerTool == null){
            mMediaPlayerTool = new ViewTool();
        }
    ...
    public class MyBinder extends Binder{
        public ViewTool getService(){
            return ViewTool.this;
        }
    }
    ...
    public void setPlayTextureView(BaseView playTextureView){
    ...
    private void cleanTextureViewParent(){
        if(srPlayTextureView != null) {
            BaseView playTextureView = srPlayTextureView.get();
